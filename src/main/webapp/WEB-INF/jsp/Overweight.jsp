...
<div>
<h2>You are : <b style="color:red" >Overweight.</b></h2>
</div>
 <div>___________________________________________________________________________________________</div>
...
<!-- Button (Double) -->
			<div style="margin-left: 210px" class="form-group">
				...
				<div class="col-md-1">
						<a href="https://www.hsph.harvard.edu/obesity-prevention-source/diet-lifestyle-to-prevent-obesity"><input type="button"
